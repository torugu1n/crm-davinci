    ...
    extend: {
      colors: {
        ...
        davinci: {
          ...
          'gold-contrast': 'var(--primary-contrast-color, #FFFFFF)',
          'black-contrast': 'var(--secondary-contrast-color, #FFFFFF)',
          white: '#FFFFFF',
      ...
      fontFamily: {
        ...
        display: ['"Instrument Sans"', 'var(--font-instrument)', 'sans-serif'],
        sans: ['"Barlow"', 'var(--font-barlow)', 'sans-serif'],
      },
      backgroundImage: {
