...
const CATEGORY_OPTIONS = [
  ...
  { value: 'ESTHETICIAN', label: 'Esteticista / Design de Sobrancelha' },
...
export default function EmployeesManager() {
  ...
  const handleSubmit = (event: React.FormEvent) => {
    ...
    const payload = {
      ...
      especialidade: formData.especialidade.trim() || categoryLabel(formData.categoria),
      miniBio: formData.miniBio.trim() || undefined,
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-white p-5 rounded-xl border border-zinc-200/85 shadow-sm">
        <div>
          ...
          <p className="text-xs text-davinci-gray mt-1">
            Cadastre profissionais, cabeleireiros(as), manicures, esteticistas e equipe de atendimento da operação.
          </p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-zinc-100">
                ...
                <button
                  ...
                  className="px-4 py-2 text-xs font-bold text-davinci-black bg-gold-gradient rounded-lg shadow-sm cursor-pointer disabled:cursor-wait disabled:opacity-60"
                >
