...
export default function BrandLogo({
  ...
  return (
    <div className={`flex items-center gap-3 ${className}`.trim()}>
      <div
        className={`${iconSizeClasses[iconSize]} rounded-2xl bg-[linear-gradient(145deg,rgba(197,168,128,0.18),rgba(255,255,255,0.98))] border border-davinci-gold/25 shadow-[0_18px_35px_rgba(197,168,128,0.12)] flex items-center justify-center backdrop-blur-sm`}
      >
        <svg
          viewBox="0 0 64 64"
          aria-hidden="true"
