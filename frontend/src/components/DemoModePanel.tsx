...
import { Sparkles, X, ChevronDown, ChevronUp, UserCheck } from 'lucide-react';
  ...
  const switchPersona = async (persona: DemoPersona) => {
    ...
    try {
      ...
      addNotification({
        ...
        description: `Carregando perfil para ${DEMO_PERSONAS[persona].label}.`,
        type: 'info',
      });
