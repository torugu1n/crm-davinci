...
import { BadgeCheck, Edit2, Lock, Mail, Plus, Shield, Trash2, UserRound, X, Camera, Percent, Scissors } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 bg-white p-5 rounded-xl border border-zinc-200/85 shadow-sm">
        <div>
          <h3 className="text-sm font-bold text-davinci-black uppercase tracking-wider">Usuários e Acessos</h3>
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  <div className="flex items-center gap-3 min-w-0">
                    {user.barber?.fotoUrl ? (
                      <img
                        src={user.barber.fotoUrl}
                        alt={user.nome}
                        className="w-14 h-14 rounded-full object-cover border border-davinci-gold/20 shrink-0"
                      />
                    ) : (
                      <div className="w-14 h-14 rounded-full bg-davinci-gold/10 border border-davinci-gold/20 flex items-center justify-center font-bold text-davinci-gold shrink-0">
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-2 flex-wrap">
                        <h4 className="text-sm font-bold text-davinci-black truncate">{user.nome}</h4>
                        <span
                  ...
                  <div className="flex items-center gap-1.5 shrink-0">
                    <button
                      ...
                      className={`relative inline-flex h-5 w-9 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none disabled:opacity-50 mr-1.5 ${
                ...
                <div className="space-y-3 text-xs">
                  ...
                  {user.barber && (
                    <>
                      ...
                      {user.barber.fotoUrl && (
                        <div className="flex items-start gap-2 text-davinci-gray">
                          <Camera className="h-4 w-4 text-davinci-gold mt-0.5" />
