...
export class WhatsappController {
  ...
  async handleWebhook(
    ...
    let finalTenantId = queryTenantId || headerTenantId;
    if (!finalTenantId && body.instance) {
      finalTenantId = await this.whatsappService.resolveTenantIdFromInstance(body.instance);
    }
    if (!finalTenantId) {
